...
namespace PICkit2V3
{
	public partial class DialogTroubleshoot : Form
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager resources = new ComponentResourceManager(typeof(PICkit2V3.DialogTroubleshoot));
			...
			this.timerPGxToggle = new Timer(this.components);
			...
			this.labelIntroText1.Text = resources.GetString("labelIntroText1.Text");
			this.labelIntroTitle.AutoSize = true;
			this.labelIntroTitle.Font = new Font("Arial", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.labelVoltageOnVDD2.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVoltageOnVDD.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVoltageOnVDD.Size = new Size(255, 40);
			...
			this.labelStep1ExtTitle.Font = new Font("Arial", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.labelTestVDD.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.numericUpDown1.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelGood.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVDDLow.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVDDShort.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelStep1Title.Font = new Font("Arial", 12f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.labelVPPMCLROff.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVPPPass.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVPPMCLR.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVPPShort.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVPPLow.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelVPPVDDShort.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.labelReadVPP.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.labelStep2FamilyVPP.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.labelPGxVDDShort.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Bold, GraphicsUnit.Point, 0);
			...
			this.labelPGxOScope.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.groupBoxPGD.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			this.groupBoxPGC.Font = new Font("Microsoft Sans Serif", 8.25f, FontStyle.Regular, GraphicsUnit.Point, 0);
			...
			base.ClientSize = new Size(445, 354);
			...
			base.FormClosing += new FormClosingEventHandler(this.TrblshtingFormClosing);
